 ...
 * Time: 1:36:36 PM
 */
public class FuseFSDirFiller
{
   private Charset cs;
   private List<FuseFSDirEnt> nodes = new ArrayList<FuseFSDirEnt>();
   ...
   public FuseFSDirEnt[] toArray() {
	   FuseFSDirEnt[] a = new FuseFSDirEnt[nodes.size()];
	   nodes.toArray(a);
	   return a;
   }
